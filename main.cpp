    ...
    while (true) {
        ...
        if (inMenu) {
            if (opcionSeleccionada == 1) {
                ...
                cout << "Selecciona la orientaci�n del triangulo (arriba, abajo, derecha, izquierda): ";
                cin.ignore();
            ...
            if (opcionSeleccionada == 2) {
                ...
                cout << "Selecciona la orientaci�n del cuadrado (arriba, abajo, derecha, izquierda): ";
                cin.ignore();
            ...
            if (opcionSeleccionada == 3) {
                ...
                cout << "Selecciona la orientaci�n del rectangulo (arriba, abajo, derecha, izquierda): ";
                cin.ignore();
            ...
            if (opcionSeleccionada == 5) {
                system("cls");
                int longitud;
                cout << "Ingresa la longitud de la l�nea: ";
                cin >> longitud;
                Figura nuevaLinea;
                ...
                cout << "Selecciona la orientaci�n de la l�nea (arriba, abajo, derecha, izquierda): ";
                cin.ignore();
            ...
            if (opcionSeleccionada == 6) {
                ...
                cout << "Selecciona la orientaci�n del rombo (arriba, abajo): ";
                cin.ignore();
            ...
            if (opcionSeleccionada == 7) {
                ...
                cout << "Selecciona la orientaci�n del hexagono (arriba, derecha): ";
                cin.ignore();
            ...
            if (opcionSeleccionada == 10) {
                ...
                switch(color){
                    ...
                    case 8:
                        ...
                        break;
                    default:
                        cout << "Opci�n no v�lida. Se mantendr� el color predeterminado." << endl;
                        break;
                }
            ...
            if (opcionSeleccionada == 12) {
                ...
                cout << "Escribir el nombre del archivo como quieres guardarlo (incluyendo la extensi�n .txt): ";
                cin >> nombreArchivo;
